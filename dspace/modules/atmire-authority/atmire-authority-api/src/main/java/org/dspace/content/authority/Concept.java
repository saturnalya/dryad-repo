...
public class Concept extends AuthorityObject
{
    ...
    {
        java.util.Date myDate = myRow.getDateColumn("created");
    ...
    {
        java.util.Date myDate = myRow.getDateColumn("modified");
    ...
    {
        try {
            java.util.Date lastModified = new java.sql.Timestamp(new java.util.Date().getTime());
